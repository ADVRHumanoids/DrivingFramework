#ifndef __MGNSS_STATE_ESTIMATION__ODOMETRY_V4_H
#define __MGNSS_STATE_ESTIMATION__ODOMETRY_V4_H
 ...
 */
class OdometryV4 : public mgnss::modules::Base {
public:
// OdometryV4(mwoibn::robot_class::Robot& robot, std::vector<std::string> names, double r);
OdometryV4(mwoibn::robot_class::Robot& robot, std::string config_file, std::string name);
OdometryV4(mwoibn::robot_class::Robot& robot, YAML::Node config);
