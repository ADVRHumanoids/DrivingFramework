...
OdometryV2(mwoibn::robot_class::Robot& robot, std::string config_file);
...
std::vector<mwoibn::Point> _estimated, _pelvis, _contact_points, _step;     // _estimated - wheel center position
