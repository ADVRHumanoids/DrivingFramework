...
#include <mwoibn/hierarchical_control/tasks/cartesian_reference_task.h>
#include <mwoibn/hierarchical_control/tasks/joint_positions_task.h>
#include <mwoibn/hierarchical_control/controlers/default.h>
...
// init robot
        ...
        mwoibn::hierarchical_control::tasks::CartesianReference cartesian(ik_0, "pelvis", robot);
        ...
        mwoibn::hierarchical_control::tasks::SelfCollision self_collision(mesh, safety_limits);
        ...
        gain << 1200;
        hierarchical_controller.addTask(cartesian, 0, 1200);
        gain << 800;
        hierarchical_controller.addTask(self_collision, 1, 800);
