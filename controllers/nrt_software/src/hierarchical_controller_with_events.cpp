...
int main(int argc, char** argv)
{
  ...
  mwoibn::hierarchical_control::CartesianSelectiveTask legs_task(
  ...
  mwoibn::hierarchical_control::OrientationSelectiveTask leg_orientation(
...
//  leg_orientation.setReference(3, mwoibn::Quaternion::fromAxisAngle(axis, 3.14));
  ...
  gain << 1;
  hierarchical_controller.addTask(&constraints_task, gain, 0, 1e-8);
  gain << 90;
  hierarchical_controller.addTask(&com_task, gain, 1, 1e-8);
//  gain << 20;
//  hierarchical_controller.addTask(&leg_orientation, gain, 2,  1e-8);
  gain << 50;
  hierarchical_controller.addTask(&pelvis_hight, gain, 3, 1e-8);
  gain << 10;
  hierarchical_controller.addTask(&legs_task, gain, 4, 1e-8);
