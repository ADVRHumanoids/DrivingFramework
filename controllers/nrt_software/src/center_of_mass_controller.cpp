...
bool resetReference(
    ...
    mwoibn::hierarchical_control::CenterOfMassTask* com_task_ptr,
...
//              true, false, false)));
  ...
  gain << 1;
  hierarchical_controller.addTask(&constraints_task, gain, 0);
  gain << 100;
  hierarchical_controller.addTask(&com_task, gain, 1);
  gain << 25;
  hierarchical_controller.addTask(&pelvis_hight, gain, 2);
