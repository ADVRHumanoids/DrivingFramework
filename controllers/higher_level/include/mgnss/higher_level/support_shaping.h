#ifndef __MGNSS_HIGHER_LEVEL_SUPPORT_SHAPING_H
#define __MGNSS_HIGHER_LEVEL_SUPPORT_SHAPING_H
 ...
 */
class SupportShaping
{

public:
  SupportShaping(mwoibn::robot_class::Robot& robot, YAML::Node config);
...
void solve(mwoibn::common::Logger& logger);
...
protected:
  ...
  double _trace, _margin = 0.2;
  mwoibn::Matrix _cost, _local_cost;
  ...
  mwoibn::VectorInt _active_links;

  std::vector<std::tuple<int, bool, bool, bool>> _limits;
