#ifndef __MGNSS_HIGHER_LEVEL_SUPPORT_SHAPING_V7_H
#define __MGNSS_HIGHER_LEVEL_SUPPORT_SHAPING_V7_H
 ...
 */
class SupportShaping7: public QrTask
{

public:
  SupportShaping7(mwoibn::robot_class::Robot& robot, YAML::Node config, std::vector<std::unique_ptr<mwoibn::robot_points::Rotation>>& steering_frames, const mgnss::higher_level::Limit& margin, const mgnss::higher_level::Limit& workspace, bool is_margin = true);
