...
void mgnss::higher_level::QrTask::solve(){
   ...
   if(verbose){
     ...
     std::cout << "inequality.jacobian\t" << _inequality.getJacobian() << std::endl;
     std::cout << "internal equality.state\t" << _equality.getState().transpose() << std::endl;
     std::cout << "internal equality.jacobian\t" << _equality.getJacobian() << std::endl;
