#ifndef PROGRAM_RT_GRAVITY_TEST_H
#define PROGRAM_RT_GRAVITY_TEST_H
...
private:
  ...
  std::unique_ptr<mwoibn::hierarchical_control::ConstraintsTask> _constraints_ptr;
  std::unique_ptr<mwoibn::hierarchical_control::CartesianSelectiveTask> _pelvis_hight_ptr;
  std::unique_ptr<mwoibn::hierarchical_control::OrientationSelectiveTask> _pelvis_orientation_ptr;
