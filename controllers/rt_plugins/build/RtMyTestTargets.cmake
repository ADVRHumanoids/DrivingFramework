...
foreach(_expectedTarget RtMyTest::RtMyTest)
...
# Create imported target RtMyTest::RtMyTest
add_library(RtMyTest::RtMyTest SHARED IMPORTED)

set_target_properties(RtMyTest::RtMyTest PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/home/user/malgorzata/workspace/src/controllers/rt_plugins/src"
)

# Import target "RtMyTest::RtMyTest" for configuration ""
set_property(TARGET RtMyTest::RtMyTest APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(RtMyTest::RtMyTest PROPERTIES
  ...
  IMPORTED_LOCATION_NOCONFIG "/home/user/malgorzata/workspace/src/controllers/rt_plugins/build/libRtMyTest.so.1.0.0"
  IMPORTED_SONAME_NOCONFIG "libRtMyTest.so.1.0.0"
  )
