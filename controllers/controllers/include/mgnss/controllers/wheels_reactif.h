...
public:
WheelsReactif(mwoibn::robot_class::Robot& robot, std::string config_file);
WheelsReactif(mwoibn::robot_class::Robot& robot, YAML::Node config);
