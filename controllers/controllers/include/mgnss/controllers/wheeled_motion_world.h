...
class WheeledMotionWorld: public modules::Base
{

public:
  WheeledMotionWorld(mwoibn::robot_class::Robot& robot, std::string config_file);
...
protected:
  ...
  std::unique_ptr<mwoibn::hierarchical_control::CenterOfMassTask>
      _com_ptr;
  std::unique_ptr<mwoibn::hierarchical_control::CartesianFlatReferenceWorld>
      _steering_ptr;
  ...
  std::unique_ptr<mgnss::events::Steering6> _steering_ref_ptr;
