...
protected:
std::unique_ptr<mwoibn::hierarchical_control::tasks::CamberAngleTask>
_leg_camber_ptr;
std::unique_ptr<mwoibn::hierarchical_control::tasks::CastorAngleTask>
_leg_castor_ptr;
std::unique_ptr<mwoibn::hierarchical_control::tasks::SteeringAngleTask>
_leg_steer_ptr;
