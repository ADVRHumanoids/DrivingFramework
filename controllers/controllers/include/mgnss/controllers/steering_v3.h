#ifndef PROGRAM_STEERING_V3_H
#define PROGRAM_STEERING_V3_H
...
public:
  Steering3(mwoibn::robot_class::Robot& robot,
           mwoibn::hierarchical_control::CartesianFlatReferenceTask2& plane, mwoibn::VectorN init_pose,
