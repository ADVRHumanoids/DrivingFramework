...
#include <mwoibn/hierarchical_control/actions/estimator.h>
#include <mwoibn/hierarchical_control/actions/restore.h>
...
#include <mwoibn/dynamic_points/force_base.h>
...
mgnss::higher_level::QrTask _force_opt;
mwoibn::Matrix _momentum_jacobian;
mwoibn::VectorN _momentum_min, _momentum_max;

const std::vector<int> _opt_forces = {0,1,2,3};

//mwoibn::robot_points::Handler<mwoibn::dynamic_points::Force> _base_force;
// mwoibn::robot_points::Handler<mwoibn::dynamic_points::DynamicPoint> _base;
// mwoibn::VectorN x_base;
// mwoibn::VectorN velocities;
