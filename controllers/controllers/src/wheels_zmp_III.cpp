...
void mgnss::controllers::WheelsZMPIII::compute()
{
        _com_ptr->update();
...
void mgnss::controllers::WheelsZMPIII::steering()
{
...
void mgnss::controllers::WheelsZMPIII::_setInitialConditions(){
...
void mgnss::controllers::WheelsZMPIII::step(){
...
void mgnss::controllers::WheelsZMPIII::_allocate(){
...
void mgnss::controllers::WheelsZMPIII::_initIK(YAML::Node config){
    ...
    shape_action__.reset(new mwoibn::hierarchical_control::actions::ShapeActionII(*_shape_extend_ptr, *_steering_ptr,
...
void mgnss::controllers::WheelsZMPIII::_createTasks(YAML::Node config){
        ...
        // }
          ...
          // if(_steering_select.count()){
            ...
            state_machine__.reset(new mgnss::higher_level::StateMachineIII(_robot, config ));
            // mwoibn::VectorInt dofs__ = ;
            _qr_wrappers["SHAPE"] = std::unique_ptr<mgnss::higher_level::SupportShaping6>(new mgnss::higher_level::SupportShaping6(_robot, config, state_machine__->steeringFrames(), state_machine__->margin(), state_machine__->workspace()));
...
void mgnss::controllers::WheelsZMPIII::log(mwoibn::common::Logger& logger, double time){
  int counter = 0;
