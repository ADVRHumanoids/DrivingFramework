...
mgnss::events::Steering4::Steering4(
...
void mgnss::events::Steering4::compute(const mwoibn::Vector3 next_step)
{
  int pow = 4;
...
void mgnss::events::Steering4::_ICM(mwoibn::Vector3 next_step)
{
...
void mgnss::events::Steering4::_SPT()
{
  for (int i = 0; i < _size; i++)
    _PT(i);
}
