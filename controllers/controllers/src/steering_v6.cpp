...
mgnss::events::  Steering6::  Steering6(
    ...
    mwoibn::hierarchical_control::  CartesianFlatReferenceWorld& plane,
...
//void mgnss::events::  Steering6::compute(const mwoibn::Vector3 next_step)
//{
//  int pow = 4;
...
void mgnss::events::  Steering6::compute2(const mwoibn::Vector3 next_step)
{
  _plane.updateState();
  _plane.updateError();
...
void mgnss::events::  Steering6::limit2PI(double ref, double& st){
...
void mgnss::events::  Steering6::limitPI(double ref, double& st){
...
void mgnss::events::  Steering6::_SPT()
{
  for (int i = 0; i < _size; i++)
    _PT(i);
}
