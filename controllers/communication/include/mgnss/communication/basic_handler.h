...
public:
  ...
  STATE getState() {
    ...
    return _state; }
  STATE getReferenceState() { return _reference_state; }

  RigidBodyDynamics::Math::Vector3d getReference() { return _reference; }
...
public:
  BasicHandler(mwoibn::hierarchical_control::ConstraintsTask& constraints,
...
//  bool set();
  ...
  bool setReferenceState(int i, STATE state){_chains[i].setReferenceState(state);}
