...
bool mgnss::ros_callbacks::wheels_controller_second_order::eventsHandler(custom_services::updatePDGains::Request& req, custom_services::updatePDGains::Response& res, mgnss::controllers::WheelsSecondOrder* controller_ptr){
...
void mgnss::ros_callbacks::wheels_controller_second_order::supportHandler(const custom_messages::CustomCmndConstPtr& msg, mgnss::controllers::WheelsSecondOrder* controller_ptr)
{
...
bool mgnss::ros_callbacks::wheels_controller_second_order::stateHandler(const custom_messages::StateMsgConstPtr& msg, mgnss::controllers::WheelsSecondOrder* controller_ptr){
