...
void mgnss::ros_callbacks::wheels_controller_events::supportHandler(const custom_messages::CustomCmndConstPtr& msg, mgnss::controllers::WheelsControllerExtend* controller_ptr)
{
...
bool  mgnss::ros_callbacks::wheels_controller_events::forceLimits(mgnss_utils::force::Request& req,
                 mgnss_utils::force::Response& res, mgnss::controllers::WheelsControllerExtend* controller_ptr){
