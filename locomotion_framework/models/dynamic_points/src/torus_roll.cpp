...
namespace dynamic_points
{
  ...
  void TorusRoll::compute(){
    ...
    _constant = _velocity_jacobian*wheel_;
    // std::cout << "5\n" << -mat_1_ << std::endl;
