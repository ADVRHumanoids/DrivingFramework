...
public:
   ...
   * dofs  **/
  unsigned int getRank() const { return _qr_ptr->rank(); }
  ...
  virtual void update() { updateDecomposition(); }
  ...
  const mwoibn::MatrixLimited& getTransformationMatrix() const { return _independent; }
