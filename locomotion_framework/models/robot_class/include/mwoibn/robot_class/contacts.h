...
public:
   ...
   *
   */
  int size() const { return _contacts.size(); } // RT?
  ...
  getActive(std::vector<std::string>* names = NULL) const; // NRT change it to work
                                                           // by type not name,
                                                           // no need for
                                                           // pointers. it can
                                                           // work through value
                                                            ...
                                                            */
  std::vector<unsigned int>
  getInactive(std::vector<std::string>* names = NULL) const; // NRT
  ...
  int jacobianCols() const {return _dofs;}
