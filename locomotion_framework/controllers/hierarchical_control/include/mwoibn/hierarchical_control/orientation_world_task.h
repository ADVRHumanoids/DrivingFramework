#ifndef HIERARCHICAL_CONTROL_ORIENTATION_WORLD_TASK_H
#define HIERARCHICAL_CONTROL_ORIENTATION_WORLD_TASK_H
 ...
 */
class OrientationWorldTask : public ControllerTask
{
...
public:
   ...
   *
   */
  OrientationWorldTask(point_handling::OrientationsHandler ik,
