...
public:
  ...
  void update()
  {
    ...
    _n = _point.getRotationWorld(_robot.state.get()).transpose() * _axis;
...
public:
  CastorAngleTask(std::vector<hierarchical_control::CastorAngle> angels,
