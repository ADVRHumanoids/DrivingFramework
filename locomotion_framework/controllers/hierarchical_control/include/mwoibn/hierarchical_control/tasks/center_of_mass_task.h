#ifndef __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CENTER_OF_MASS_H
#define __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CENTER_OF_MASS_H
...
class CenterOfMass : public BasicTask
{
 ...
 */
CenterOfMass(mwoibn::robot_class::Robot& robot,
             mwoibn::VectorN reference =
                     mwoibn::VectorN::Zero(2))
        : BasicTask(), _robot(robot), _reference(reference)
{
...
const mwoibn::VectorN& getReference() {
        return _reference;
}
