#ifndef __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CATRESIAN_SIMPLIFIED_PELVIS_4_H
#define __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CATRESIAN_SIMPLIFIED_PELVIS_4_H

#include "mwoibn/hierarchical_control/tasks/contact_point_2D_rbdl_task.h"
 ...
 *
 */
class CartesianFlatReferenceV4 : public ContactPoint2DRbdl
{
 ...
 *
 */
CartesianFlatReferenceV4(point_handling::PositionsHandler ik,
                         mwoibn::robot_class::Robot& robot)
        : ContactPoint2DRbdl(ik, robot)
{
        init();
}

virtual ~CartesianFlatReferenceV4() {
}
