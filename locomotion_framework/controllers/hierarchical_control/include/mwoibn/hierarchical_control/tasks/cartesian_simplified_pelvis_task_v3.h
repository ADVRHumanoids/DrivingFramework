#ifndef __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CATRESIAN_SIMPLIFIED_PELVIS_H
#define __MWOIBN_HIERARCHICAL_CONTROL_TASKS_CATRESIAN_SIMPLIFIED_PELVIS_H
 ...
 *
 */
class CartesianSimplifiedPelvis : public ContactPoint2DRbdl
{
...
public:
   ...
   *
   */
  CartesianSimplifiedPelvis(point_handling::PositionsHandler ik,
  ...
  virtual ~CartesianSimplifiedPelvis() {}
