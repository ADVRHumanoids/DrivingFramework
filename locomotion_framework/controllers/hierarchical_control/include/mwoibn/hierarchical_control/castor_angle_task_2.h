#ifndef HIERARCHICAL_CONTROL_CASTOR_ANGLE_TASK_2_H
#define HIERARCHICAL_CONTROL_CASTOR_ANGLE_TASK_2_H
...
protected:
 ...
 class CastorAngleTask2 : public ControllerTask
 {

 public:
  CastorAngleTask2(std::vector<hierarchical_control::CastorAngle2> angels, mwoibn::robot_class::Robot& robot)
...
//    std::cout << std::endl;
 ...
 protected:
  ...
  std::vector<hierarchical_control::CastorAngle2> _angles;
 };
} // namespace package
} // namespace library
#endif
