...
void mwoibn::hierarchical_control::CenterOfMassTask2::updateError()
{
  _last_error = _error;
...
void mwoibn::hierarchical_control::CenterOfMassTask2::updateJacobian()
{
...
void mwoibn::hierarchical_control::CenterOfMassTask2::update()
{
