#include "mwoibn/hierarchical_control/tasks/center_of_mass_task_v3.h"

void mwoibn::hierarchical_control::tasks::CenterOfMass3::updateError()
{
  _last_error = _error;
...
void mwoibn::hierarchical_control::tasks::CenterOfMass3::updateJacobian()
{
...
void mwoibn::hierarchical_control::tasks::CenterOfMass3::update()
{
