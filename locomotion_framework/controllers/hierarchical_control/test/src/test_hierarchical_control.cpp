...
{
        mwoibn::hierarchical_control::controllers::Default hc;
}
...
TEST(ControlerTaskTest, methodsBaseClass)
{
        ...
        mwoibn::hierarchical_control::tasks::SelfCollision sc(collision, 0.05);
        ...
        mwoibn::hierarchical_control::tasks::CartesianWorld ct_1(ik_1);

        mwoibn::hierarchical_control::tasks::CartesianWorld ct_2(ik_2);
